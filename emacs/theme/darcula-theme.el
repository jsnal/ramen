;;; darcula-theme.el --- A complete port of the default JetBrains Darcula theme -*- lexical-binding: t; -*-

;; Copyright (C) 2020-2022, Ian Y.E. Pan, Jason Long
...
(let ((class '((class color) (min-colors 89)))
      ...
      (fg4                "#fafafa")
      (bg0                "#111111")
      (bg1                "#1c1c1c") ; default bg
      (bg2                "#303030")
      (bg3                "#282828") ; hl-line
      (bg4                "#383c3f")
      (bg5                "#2c2f31") ; tab-bar active tab
      (bg-hl              "#214283")
      (jb-r               "#ac0909")
      (jb-g               "#36a546")
      (jb-y               "#f1eb7f")
  ...
  (custom-theme-set-faces
   ...
   `(highlight                                ((,class (:foreground ,bg5 :background ,fg3))))
   ...
   `(isearch                                  ((t (:foreground ,accent :background ,"#32593D"))))
   `(isearch-fail                             ((t (:foreground ,accent :background ,jb-red))))
   `(lazy-highlight                           ((t (:foreground ,accent :background ,"#155221"))))
   `(vertical-border                          ((,class (:foreground ,bg5))))
   `(minibuffer-prompt                        ((,class (:foreground ,jb-blue :bold t))))
   ...
   `(line-number                              ((,class (:foreground ,line-num :background ,bg5))))
   `(line-number-current-line                 ((,class (:foreground ,fg1 :background ,bg5))))
   ...
   `(org-done                                 ((,class (:box (:line-width 1 :color ,bg5) :bold nil :foreground ,bg4))))
   `(org-warning                              ((,class (:underline t :foreground ,warning))))
   `(org-agenda-structure                     ((,class (:weight normal :foreground ,fg3 :box (:color ,fg4) :background ,bg5))))
   ...
   `(ido-only-match                           ((,class (:foreground ,jb-green :bold t))))
   `(ido-subdir                               ((,class (:foreground ,jb-blue :bold t))))
   `(ido-first-match                          ((,class (:foreground ,jb-magenta :bold t))))
   ...
   `(magit-blame-heading                      ((t (:foreground ,jb-orange :background ,bg5 :extend t))))
   ...
   `(magit-section-highlight                  ((t (:background ,bg5 :extend t))))
   ...
   `(term-color-black                         ((,class (:foreground ,fg1 :background ,bg5))))
   `(term-color-blue                          ((,class (:foreground ,jb-blue :background ,func))))
   `(term-color-red                           ((,class (:foreground ,jb-red :background ,bg5))))
   `(term-color-green                         ((,class (:foreground ,jb-green :background ,bg5))))
   ...
   `(helm-visible-mark                        ((,class (:foreground ,bg1 :background ,bg5))))
   ...
   `(ediff-even-diff-Ancestor                 ((t (:background ,bg5))))
   `(ediff-even-diff-A                        ((t (:background ,bg5))))
   `(ediff-even-diff-B                        ((t (:background ,bg5))))
   `(ediff-even-diff-C                        ((t (:background ,bg5))))
   `(ediff-odd-diff-Ancestor                  ((t (:background ,bg5))))
   `(ediff-odd-diff-A                         ((t (:background ,bg5))))
   `(ediff-odd-diff-B                         ((t (:background ,bg5))))
   `(ediff-odd-diff-C                         ((t (:background ,bg5))))
   ...
   `(solaire-hl-line-face                     ((t (:inherit hl-line :background ,bg5))))
